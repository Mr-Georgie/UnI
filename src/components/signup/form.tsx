...
import { setSignUpCallBackUrl } from "@/lib/nextauth/utils";
...
export function SignUpForm() {
    ...
    const callbackUrl = setSignUpCallBackUrl(searchParams.get("callbackUrl"));
        ...
        <Card className="font-plus_jakarta_sans">
            ...
            <CardFooter className="flex flex-col gap-8">
                <div>
                    ...
                    <Link href="/auth/signin" className="underline px-3">
                        click here
                    </Link>
                </div>
            </CardFooter>
