...
const config = {
    ...
    theme: {
        ...
        extend: {
            ...
            backgroundImage: {
                "custom-gradient":
                    "linear-gradient(to bottom, #3eb075 0%, #34829b 50%, #2a54c2 100%)",
            },
            colors: {
                brand: "#3870FF",
                "brand-dark": "#264cad",
            ...
            fontSize: {
                ...
                "heading-5": ["1.125rem", { lineHeight: "1.5rem" }], // 18px
                "heading-6": ["1rem", { lineHeight: "1.5rem" }], // 16px
                paragraph: ["1rem", { lineHeight: "1.5rem" }], // 16px
